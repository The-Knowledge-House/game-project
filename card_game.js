...
let input = getInput(`Will the following card be higher(h) or lower (l)`);
...
if (guess(currentCard, nextCard) == true) {
      score++;
      console.log(`Congratz, your score is ${score}`);
    } else {
      console.log(`You are so wrong, no points for you`);
    }
...
deck.length === 0
    ? console.log(`You have lost. you're outta here!.`)
